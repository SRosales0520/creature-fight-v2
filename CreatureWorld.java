 ...
 * Teacher: Mr. Hardman 
 * Date Last Modified: november 22th 2018 
 */
...
public class CreatureWorld extends World
{
    ...
    public void act()
    {
        ...
        if (turnNumber == 0)
        {
            ...
            playerOneName = JOptionPane.showInputDialog(null, "Please enter Player One's name", "Name Input#1", JOptionPane.QUESTION_MESSAGE);
            ...
            playerTwoName = JOptionPane.showInputDialog(null, "Please enter Player Two's name", "Name Input#1", JOptionPane.QUESTION_MESSAGE);
        ...
        else if (turnNumber == 1)
        {
            ...
            showText(" it is "+ playerOneName + "'s turn", getHeight() /2, getWidth() /2);
        }
        //TODO (22): Otherwise...
        else
        {
            ...
            showText(" it is "+ playerTwoName + "'s turn", getHeight() /2, getWidth() /2);
        }
        if( playerOneCreature.getHealthBar().getCurrent() <= 0 )
        {
            ...
            showText("Player " + playerTwoName + "wins!!", getWidth()/2, getHeight()/2);
            Greenfoot.stop();
        }
